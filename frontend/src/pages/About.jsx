  ...
  return (
    <div>
      ...
      <div className='my-10 flex felx-col md:flex-row gap-16'>
        ...
        <p>At Mirepet, we believe that pets are family — and they deserve the very best.
Our mission is to create a trusted ecosystem where every pet owner can find what they need in one place, from essential supplies to professional veterinary care.</p>
        ...
        <b className='text-gray-800'>Mirepet Shop</b>
        ...
        <b className='text-gray-800'>Mirepet Vet</b>
